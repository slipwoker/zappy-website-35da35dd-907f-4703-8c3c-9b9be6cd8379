    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Bill Me uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '35da35dd-907f-4703-8c3c-9b9be6cd8379',
                    name: data.name || '',
                    email: data.email || '',
